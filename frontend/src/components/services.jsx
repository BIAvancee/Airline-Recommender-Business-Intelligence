            ...
            <Form style={{ width: "40%", marginLeft: "30%", marginRight: "25%" }} onSubmit={formik.handleSubmit} >
                ...
                <Form.Group >
                    <Form.Label>To</Form.Label>
                        <select name="to" id="select" value={formik.values.to} class="form-control " onChange={formik.handleChange}>
                            <option value="Select a country ... " selected="selected">Select a country ... </option>
                            <optgroup id="country-optgroup-Africa" value="Africa">
                                <option value="Algeria">Algeria</option>
                                <option value="Angola">Angola</option>
                ...
                <br /> 
                <Button style={{ marginLeft: "30%",marginBottom:"3%" }} id="butt"  type="submit"   >Best airline</Button> 
            </Form>
            <div>
            {/* {
                  data.map((item, index) => (
